...
QuoteBox.propTypes = {
    enterText: React.PropTypes.func,
    setDestination: React.PropTypes.func,
    setDateWithRelated: React.PropTypes.func,
    getSearchResults: React.PropTypes.func,
    originSuggests: React.PropTypes.array,
    destinationSuggests: React.PropTypes.array,
    departureDate: React.PropTypes.object,
